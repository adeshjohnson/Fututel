...
public class SipConfigManager {
     ...
     * earpiece<br/>
     * Leave it managed by Fututel if you want to benefit auto detection
     * 
     * @see #setPreferenceBooleanValue(Context, String, boolean)
     */
     ...
     * And Fututel has different implementations for each ways, the backend
     * can be configured
     * 
     * @see #setPreferenceIntegerValue(Context, String, Integer)
     ...
     */
    public static final String AUTHORITY = "com.fututel.prefs";
