...
import com.fututel.utils.AccountListUtils;
import com.fututel.utils.AccountListUtils.AccountStatusDisplay;
...
public class AccountChooserButton extends LinearLayout implements OnClickListener {
    ...
    public AccountChooserButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        telCmp = new ComponentName(getContext(), com.fututel.plugins.telephony.CallHandler.class);
    ...
    public void setAccount(SipProfile aAccount) {
        ...
        if (account == null) {
            if(isInEditMode() || Compatibility.canMakeGSMCall(getContext())) {
                ...
                imageView.setImageResource(R.drawable.ic_ls_dialer_holo_dark);
            }else {
                textView.setText(getResources().getString(R.string.acct_inactive));
                imageView.setImageResource(R.drawable.ic_ab_dialer_holo_dark_inv);
            }
        } else {
