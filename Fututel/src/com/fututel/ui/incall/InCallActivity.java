...
import com.fututel.api.ISipService;
import com.fututel.api.MediaState;
...
import com.fututel.ui.PickupSipUri;
import com.fututel.ui.incall.CallProximityManager.ProximityDirector;
import com.fututel.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.fututel.utils.CallsUtils;
import com.fututel.utils.DialingFeedback;
import com.fututel.utils.Log;
import com.fututel.utils.PreferencesProviderWrapper;
import com.fututel.utils.Theme;
import com.fututel.utils.keyguard.KeyguardWrapper;
import com.fututel.widgets.IOnLeftRightChoice;
import com.fututel.widgets.ScreenLocker;
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.fututel.videoCall");
