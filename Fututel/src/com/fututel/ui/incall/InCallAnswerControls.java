...
import com.fututel.widgets.AlternateUnlocker;
import com.fututel.widgets.IOnLeftRightChoice;
import com.fututel.widgets.SlidingTab;
        ...
        if(visibility == View.VISIBLE) {
            ...
            if(useSlider) {
                ...
                if(alternateLockerWidget == null) {
                    ...
                    this.addView(alternateLockerWidget, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT); //rangdong
                }
            }
        }
