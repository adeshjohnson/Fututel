...
package com.fututel.ui.account;
...
import com.fututel.ui.account.AccountsEditListAdapter.AccountRowTag;
import com.fututel.ui.account.AccountsEditListAdapter.OnCheckedRowListener;
import com.fututel.widgets.CSSListFragment;
import com.fututel.widgets.DragnDropListView;
import com.fututel.widgets.DragnDropListView.DropListener;
import com.fututel.wizards.BasePrefsWizard;
import com.fututel.wizards.WizardChooser;
...
public class AccountsEditListFragment extends CSSListFragment implements /*OnQuitListener,*/ OnCheckedRowListener{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if (account.username == null || account.username  == "")
            startActivityForResult(new Intent(getActivity(), WizardChooser.class),  CHOOSE_WIZARD); //rangdong
        else
            showDetails(1, "BASIC");
	}
...
//                })
//                .setShowAsAction(
//                        MenuItem.SHOW_AS_ACTION_IF_ROOM );//rangdong
