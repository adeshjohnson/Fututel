    ...
    //                    }
            ...
            case TYPE_UI: {
                ...
                if(!pfw.isAdvancedUser()) {
                    ...
                    pfh.hidePreference("android_integration", SipConfigManager.INTEGRATE_WITH_DIALER);
                    pfh.hidePreference("android_integration", SipConfigManager.INTEGRATE_WITH_CALLLOGS);
                    pfh.hidePreference("android_integration", "gsm_integration_type");
                    pfh.hidePreference("android_integration", "obtain_themes");
                    pfh.hidePreference(null, "android_integration"); //rangdong
