...
import com.fututel.utils.Ringer;
import com.fututel.utils.accessibility.AccessibilityWrapper;
import com.fututel.utils.audio.AudioFocusWrapper;
import com.fututel.utils.bluetooth.BluetoothWrapper;
import com.fututel.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.fututel.onIncomingCall.SCREEN");
