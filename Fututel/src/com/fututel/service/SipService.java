...
import com.fututel.models.Filter;
import com.fututel.pjsip.PjSipCalls;
import com.fututel.pjsip.PjSipService;
import com.fututel.pjsip.UAStateReceiver;
import com.fututel.service.receiver.DynamicReceiver4;
import com.fututel.service.receiver.DynamicReceiver5;
import com.fututel.ui.incall.InCallMediaControl;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.fututel.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.fututel.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.fututel.SipService");
