...
import com.fututel.ui.outgoingcall.OutgoingCallChooser;
import com.fututel.utils.CallHandlerPlugin;
		...
		if (action.equals(Intent.ACTION_NEW_OUTGOING_CALL) ) {
			...
			if(prefsWrapper.isValidConnectionForOutgoing() || potentialHandlers.size() > 1) {
	            ...
	            if(gsmCallHandlerId == null) {
	                gsmCallHandlerId = CallHandlerPlugin.getAccountIdForCallHandler(aContext, (new ComponentName(aContext, com.fututel.plugins.telephony.CallHandler.class)).flattenToString());
	            }
				...
				Log.d(THIS_FILE, "Start outgoing call chooser for Fututel");
