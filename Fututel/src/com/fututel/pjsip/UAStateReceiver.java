...
import com.fututel.service.SipNotifications;
...
import com.fututel.service.impl.SipCallSessionImpl;
import com.fututel.utils.CallLogHelper;
import com.fututel.utils.Log;
import com.fututel.utils.Threading;
...
public class UAStateReceiver extends Callback {
    ...
    private void broadCastAndroidCallState(String state, String number) {
        ...
        //pjService.service.sendBroadcast(intent, android.Manifest.permission.READ_PHONE_STATE);//rangdong
    }
