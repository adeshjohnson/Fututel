...
public class PreferencesWrapper {
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.USE_COMPACT_FORM, true);//rangdong
		...
		put(SipConfigManager.USE_3G_IN, true);//rangdong
		put(SipConfigManager.USE_3G_OUT, true);//rangdong
		...
		put(SipConfigManager.CODECS_PER_BANDWIDTH, false);//rangdong
        ...
        put(SipConfigManager.USE_VIDEO, false);//rangdong
