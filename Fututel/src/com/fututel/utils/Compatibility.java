...
public final class Compatibility {
    ...
    private static void resetCodecsSettings(PreferencesWrapper preferencesWrapper) {
        ...
        preferencesWrapper.setCodecPriority("G729/8000/1", SipConfigManager.CODEC_NB, "1");
        ...
        preferencesWrapper.setCodecPriority("G722/16000/1", SipConfigManager.CODEC_WB,
                supportFloating ? "235" : "1");
        preferencesWrapper.setCodecPriority("iLBC/8000/1", SipConfigManager.CODEC_WB, "1");
        preferencesWrapper.setCodecPriority("GSM/8000/1", SipConfigManager.CODEC_WB, "1");
        ...
        preferencesWrapper.setCodecPriority("AMR/8000/1", SipConfigManager.CODEC_WB, "1");
        preferencesWrapper.setCodecPriority("AMR-WB/16000/1", SipConfigManager.CODEC_WB, "1");
