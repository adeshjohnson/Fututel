...
package com.fututel.utils.contacts;
...
public class ContactsUtils5 extends ContactsWrapper {
    ...
    public void bindAutoCompleteView(View view, Context context, Cursor cursor) {
        ...
        ContactsAsyncHelper.updateImageViewWithContactAsync(context, imageView, uri, R.drawable.ic_contact_picture_holo_light);
    }
    ...
    public void bindContactPhoneView(View view, Context context, Cursor cursor) {
        ...
        Bitmap bitmap = getContactPhoto(context, uri, false, R.drawable.ic_contact_picture_holo_light);
