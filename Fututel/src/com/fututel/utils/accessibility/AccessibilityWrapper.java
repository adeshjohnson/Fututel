...
package com.fututel.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.fututel.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.fututel.utils.accessibility.Accessibility3();
			}
		}
